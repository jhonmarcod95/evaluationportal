    ...
    <div class="row m-b-lg m-t-lg">
        <div class="col-md-4">
            ...
            <div class="profile-image">
                <img src="{{'http://10.96.4.126:8668/storage/id_image/employee_image/'.Auth::user()->employee_info()->id.'.png'}}" class="rounded-circle circle-border m-b-md" alt="profile">
            </div>
            <div class="profile-info">
                <div class="">
                    <div>
                        ...
                        <h4>Company : {{$employee->EmployeeCompany[0]->name}}</h4>
                        <h5> Department : {{$employee->EmployeeDepartment[0]->name}}</h5>
                        <h6> Position : {{$employee->position}}</h6>
                        <small>
                            <i class="fa fa-map-marker"></i> {{$employee->EmployeeLocation[0]->name}}
                        </small><br>
                        <small>
                            <i class="fa fa-envelope"></i> {{$employee->EmployeeUser->email}}
                        </small><br>
                        <small>
                            <i class="fa fa-phone"></i> {{$employee->EmployeeUser->email}}
                        </small>
                    </div>
                </div>
            </div>
